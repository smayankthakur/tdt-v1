...
export const hi: TranslationSchema = {
  ...
  about: {
    ...
    why: {
      ...
      p3: 'चाहे आप रात 2 बजे दिमाग घूम रहा हो या बड़े फैसले से पहले त्वरित दृष्टिकोण चाहते हों — जवाब यहाँ हैं, आपका इंतज़ार कर रहे हैं।',
    },
    cta: {
      ...en.about.cta,
  ...
  testimonials: {
   ...
   whySection: {
      ...
      description: 'हम प्राचीन तरबूत ज्ञान को आपकी ऊर्जा के साथ जोड़ते हैं - ऐसे रीडिंग जो व्यक्तिगत, गहन और आपके लिए सटीक हों।',
      readings: '10,000+ रीडिंग',
      rating: '4.9 रेटिंग',
      speed: '60 सेकंड से कम',
      features: {
        personalized: 'आपकी ऊर्जा के आधार पर व्यक्तिगत रीडिंग',
        ai: 'गहराई से अंतर्दृष्टि जिसमें मानवीय गर्माहट है',
  ...
  contact: {
    ...
    nameHelper: 'क्यों? ताकि हम आपको व्यक्तिगत रूप से संबोधित कर सकें',
    email: 'ईमेल',
    emailPlaceholder: 'name@example.com',
    emailHelper: 'हम आपको ईमेल पर परिणाम भेजेंगे',
    message: 'संदेश',
    messagePlaceholder: 'आप क्या जानना चाहते हैं?',
    messageHelper: 'स्पष्ट सवाल - स्पष्ट उत्तर',
    submit: 'संदेश भेजें',
    success: {
