...
finalCta: {
  ...
  home: {
    about: {
      title: 'על המסע',
      description: 'הפלטפורמה הזו לא נוצרה רק לקריאות... היא נוצרה לתת בהירות כשהחיים נראים מבלבלים.',
      bio: 'בהטי סינג היא קוראת טארוט מנוסה עם יותר מ-10 שנות ניסיון בהנחיית אנשים דרך אי-הוודאויות של החיים.',
      linkText: 'למד עוד עלינו',
    },
  },
};
